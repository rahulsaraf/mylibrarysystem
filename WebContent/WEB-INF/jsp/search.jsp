...
<script type="text/javascript">
    ...
    function alertme(index) {
		...
		var dateout1 = dateOut.getFullYear()+ '-' + (dateOut.getMonth() + 1) + '-' + dateOut.getDate();
		var duedate1 = dueDate.getFullYear()+ '-' + (dueDate.getMonth() + 1) + '-' + dueDate.getDate();
		...
		$('#d_title').val(title);
		$('#d_dateOut').val(dateout1);
		$('#d_dueDate').val(duedate1);
	...
	<div class="container">
		...
		<c:choose>
    		...
    		<c:when test="${result == 3}">
			    <div class="alert alert-danger fade in">
	        	<a href="#" class="close" data-dismiss="alert">&times;</a>
	        	<strong>Error!</strong> Check-out failed, Invalid Card No.
    			</div>
    		</c:when>
    	</c:choose>
		...
		<div class="container row">
			<div class="well bs-component">
				<form class="form-horizontal" name="searchbook" action="searchbook"
					...
					<fieldset>
						<legend>
							<span> Search and Check-out Books</span>
								...
								<div id="criteria">
									...
									<div class="form-group">
										<label for="dateOut" class="col-lg-3 control-label">Date
											Out <span class="text-danger">* </span>:</label>
										<div class="col-lg-8">
